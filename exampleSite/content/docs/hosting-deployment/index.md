...
- Cybercriminels, hackers : objectif visé  "Lucratif, espionnage, sabotage.."
- Employés malintentionnés : objectif visé  "Amusement, Influence, manipulation,.."
 
    
#### Quel est le niveau de pertinence pour chaque groupe SR/OV ?
- Ex : Le cybercriminel serait potentiellement plus intéressé par le vol/divulgation/.. des données personnelles associées à la gestion et suivi des  dossiers "clients/patients/.."
- Ex : l’employé malintentionné  serait plus intéressé par la manipulation de Ddnnées personnelles à des fins personnelles (influsence/manipulation/..

#### Prendre en compte la pertinence du couple SR/OV et gravité des ER
