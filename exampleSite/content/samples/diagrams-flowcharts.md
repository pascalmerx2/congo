...
| --------------- | --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Gouvernance** | Assurer le pilotage global de la conformité                     | - Ex Validation du registre de traitements par la direction<br>- Ex Suivi semestriel DPO / RSSI<br>- Ex Contrôle d’accès validé par les métiers                         |
| **Protection**  | Empêcher l’accès non autorisé aux données                       | - Ex Mise en place d’un MFA <br>- Ex Cloisonnement des comptes soignants<br>- Chiffrement du NAS de sauvegarde                                           |
| **Défense**     | Détecter les anomalies et violations                            | - Ex Activation de la traçabilité des accès<br>- Ex Définition d’une procédure interne de notification CNIL<br>- Ex Formation du personnel à la détection de fuites     |
| **Résilience**  | Garantir la continuité des soins et la récupération des données | - Ex Sauvegarde quotidienne testée trimestriellement<br>- Ex Plan de reprise informatique (PRA)<br>- Ex Procédure papier de continuité des soins en cas de panne réseau |
